...
import console.Conwaysgameoflife;
 ...
 * @co-author Sai chandra Bussa 2020501006
 * Date of implementation:2020-12-29
...
//	private Rectangle rect_middle = new Rectangle(5,5,6,6);
	private Rectangle rect_middle = new Rectangle(5,5,ConwayMain.WINDOW_WIDTH-6, controlPanelHeight-15);
	private Rectangle rect_inner =  new Rectangle(6,6,ConwayMain.WINDOW_WIDTH-8, controlPanelHeight);
//	private Rectangle rect_inner =  new Rectangle(6,6,6,6);

	// This attribute retains a copy of a reference to the application's Pane 
	private Pane window;
	
//	Board b1= new Board(100);
//	Board b2= new Board(100);	// These attributes define the Board used by the simulation and the graphical representation
...
//	private Board evenGameBoard =  new Board();	// The Board for even frames of the animation
	...
	private int[][] arr;							//Array used to insert the 
	Conwaysgameoflife c = new Conwaysgameoflife(); 	//Conways 2.0 object created
	Rectangle r=new Rectangle(0,0,0,0);				//rectangle object to add in to the scene
...
//	GridPane gridPane = new GridPane();
	...
	private boolean fileContentsAreValid() {
		...
		Scanner sc=scanner_Input;
		ArrayList<String> al=new ArrayList<>();		//Array list used to read input
